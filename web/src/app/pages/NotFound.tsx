  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-5 bg-paper px-4 text-center">
      ...
      <div className="space-y-2">
        ...
        <h1 className="o-display text-3xl">{t("This branch doesn't exist.")}</h1>
        <p className="text-sm leading-6 text-ink-muted">{t("The page you're looking for was moved, renamed, or never grew here.")}</p>
      </div>
